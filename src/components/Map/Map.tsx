...
export const Map = () => {
  return (
    <section
      ...
      className="relative flex w-full max-w-6xl scroll-my-24 flex-col items-center justify-center overflow-hidden rounded-2xl bg-neutral-950 px-10 shadow-2xl shadow-black/50 sm:px-16 md:px-28 lg:mx-auto my-6"
    >
      {/* Left & Right Borders */}
      <div className="absolute left-0 z-10 h-full backdrop-blur-[2px]">
        <svg
          className="h-full w-8 border-r border-neutral-900 stroke-neutral-800 sm:w-20"
          style={{
            maskImage:
      ...
      <div className="pt-12 text-base font-semibold tracking-tight text-orange-400 sm:pt-20 sm:text-lg">
        BreezeUI Feature Map
      </div>
      <h2
        id="feature-title"
        className="mt-6 max-w-[700px] text-center text-2xl font-semibold tracking-tight text-balance text-white md:text-5xl"
      >
        Explore & Visualize Interactive Components
      </h2>
      <p className="mt-4 max-w-2xl text-center text-base text-balance text-neutral-400 sm:mt-8 sm:text-xl">
        BreezeUI enables effortless integration of modern UI components, providing real-time previews, 
        responsive layouts, and interactive features designed for developers to build stunning web applications with ease.
      </p>
      ...
      <div className="relative mt-20 mb-10 ml-[17rem] scale-90 sm:mb-16 md:mt-24 md:ml-0 md:scale-100">
        ...
        <div className="absolute -top-3 left-[130px]">
          <div className="relative flex items-center justify-center">
            <div className="absolute size-10 rounded-full bg-neutral-950 ring-1 ring-white/15"></div>
            <div className="absolute -top-4 -right-[3.7rem] flex w-fit items-center justify-center rounded-full bg-neutral-950 px-1.5 py-0.5 text-xs whitespace-nowrap text-white ring-1 ring-white/15">
              Live Preview
            </div>
        ...
        <div className="absolute top-12 right-[430px]">
          <div className="relative flex items-center justify-center">
            <div className="absolute size-10 rounded-full bg-neutral-950 ring-1 ring-white/15"></div>
            <div className="absolute -top-4 -right-7 flex w-fit items-center justify-center rounded-full bg-neutral-950 px-1.5 py-0.5 text-xs whitespace-nowrap text-white ring-1 ring-white/15">
              Copy & Customize
            </div>
        ...
        <div className="absolute top-9 right-56">
          <div className="relative flex items-center justify-center">
            ...
            <div className="absolute size-10 rounded-full bg-neutral-950 ring-1 ring-white/15 backdrop-blur-sm"></div>
          </div>
        </div>
      </div>
    </section>
