...
import { HelpCircle, Download, Copy } from "lucide-react";
...
// Dub QR logo (base64 encoded SVG)
const DUB_QR_LOGO = "data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMTAwIiBoZWlnaHQ9IjEwMCIgdmlld0JveD0iMCAwIDEwMCAxMDAiIGZpbGw9Im5vbmUiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyI+CjxyZWN0IHdpZHRoPSIxMDAiIGhlaWdodD0iMTAwIiBmaWxsPSJibGFjayIvPgo8L3N2Zz4=";
...
// ShimmerDots component for background effect
function ShimmerDots({ className }: { className?: string }) {
  return (
    <div className={cn("absolute inset-0", className)}>
      <svg className="size-full" xmlns="http://www.w3.org/2000/svg">
        ...
        <rect width="100%" height="100%" fill="url(#shimmer-dots)" />
      </svg>
    </div>
  );
}
