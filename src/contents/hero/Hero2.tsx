  ...
  return (
    <main className="flex flex-1 w-full flex-col items-center justify-center text-center px-4 sm:mt-28 mt-20 py-6">
      ...
      <p className="mx-auto mt-12 max-w-xl text-lg text-slate-700 leading-7">
        Want to style up your photos? Maybe get that perfect LinkedIn headshot?
        Let our AI do its magic and replace your background with your color of
        choice. 100% free – pop your photos today.
      </p>
      <a
